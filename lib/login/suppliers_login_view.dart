...
import 'package:flutter_application_1/login/suppliers_singn_up_view.dart';
import 'package:flutter_application_1/moreUsers/supliers/first_suppliers_more.dart';
...
class SuppliersLoginView extends StatefulWidget {
  const SuppliersLoginView({super.key});

  @override
  State<SuppliersLoginView> createState() => _SuppliersLoginViewState();
}

class _SuppliersLoginViewState extends State<SuppliersLoginView> {
                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const SuppliersSignUpView(),
                        ),
                      );
                    },
                    child: Row(
