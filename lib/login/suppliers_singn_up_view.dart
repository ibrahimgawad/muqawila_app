...
class SuppliersSignUpView extends StatefulWidget {
  const SuppliersSignUpView({super.key});

  @override
  State<SuppliersSignUpView> createState() => _SuppliersSignUpViewState();
}

class _SuppliersSignUpViewState extends State<SuppliersSignUpView> {
                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const SuppliersLoginView(),
                        ),
                      );
                    },
                    child: Row(
